...
/**
 * {@code Forward} action can be used to invoke an http/2 call with incoming request httpVerb.
 */
@BallerinaAction(
...
public class Http2Forward extends Forward {

    private static final Logger logger = LoggerFactory.getLogger(Http2Forward.class);
    ...
    public ConnectorFuture execute(Context context) {
        ...
        try {
            ...
            throw new BallerinaException("Failed to invoke 'forward' action in " + HttpConstants.HTTP2_CONNECTOR_NAME
