...
/**
 * {@code Patch} is the PATCH action implementation of the HTTP2 Connector.
 */
@BallerinaAction(
...
public class Http2Patch extends Patch {

    private static final Logger logger = LoggerFactory.getLogger(Http2Patch.class);
    ...
    public ConnectorFuture execute(Context context) {
        ...
        try {
            ...
            throw new BallerinaException("Failed to invoke 'patch' action in " + HttpConstants.HTTP2_CONNECTOR_NAME
