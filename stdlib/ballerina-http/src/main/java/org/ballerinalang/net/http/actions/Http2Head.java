...
/**
 * {@code Head} is the HEAD action implementation of the HTTP2 Connector.
 */
@BallerinaAction(
...
public class Http2Head extends Head {

    private static final Logger logger = LoggerFactory.getLogger(Http2Head.class);
    ...
    public ConnectorFuture execute(Context context) {
        ...
        try {
            ...
            throw new BallerinaException("Failed to invoke 'head' action in " + HttpConstants.HTTP2_CONNECTOR_NAME
